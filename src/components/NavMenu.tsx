...
export default function NavMenu({ name }: NavMenuProps) {
  ...
  const logout =()=>{
     localStorage.removeItem('AUTH_TOKEN');// eliminar el token de autenticacion
      queryClient.removeQueries({queryKey:['user']}) // invalidar la consulta de usuario
      navigate('/auth/login') // redirigir a la pagina de login

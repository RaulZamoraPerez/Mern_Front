...
export type UpdateCurrentPasswordForm = Pick<Auth, 'password' | 'current_password' | 'password_confirmation'>
...
//para validar que la data te llegue como un array de objetos
